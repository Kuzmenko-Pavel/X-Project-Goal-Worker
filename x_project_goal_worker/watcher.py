...
from x_project_goal_worker.worker import Worker
...
class Watcher(object):
    ...
    def __init__(self, config, click_collection, goals_collection):
        ...
        self._worker = Worker(self._messages, click_collection, goals_collection, config)
